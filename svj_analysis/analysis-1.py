#!/usr/bin/env python3
"""
Program: This .py is the my first script to analyze HEP data.
         
         For this .py, I do a demo to do the test in
         /youwei_home/SVJ_Model/s-channel/Analysis/.
...
df_xdxdx_71 = myafv2.parse_xdxdx_v2(GP, status=71)
...
list_SFSP, list_SFSP_filterDM = myafv2.selectStableFinalStateParticle_filterDM(
    GP, FILTER=[51, -51, 53, -53])
...
list_detector_jet = myafv2.preselectDetectorJet(Jet, N_JET_MIN=N_jet,
                                                PT1_MIN=pT1_min,
                                                PT2_MIN=pT2_min,
                                                ETA_MAX=eta12_max)
